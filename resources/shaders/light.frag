...
uniform PointLight in_pLight[MAXPOINT];
uniform samplerCube in_pointShadowMap[MAXPOINT];

uniform DirLight in_dLight[MAXDIR]; 
uniform sampler2D in_dirShadowMap[MAXDIR];

uniform SpotLight in_sLight[MAXSPOT];
uniform sampler2D in_spotShadowMap[MAXSPOT];
...
uniform int in_numPoint;
uniform int in_numSpot;
uniform int in_numDir;
